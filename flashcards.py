...
class LogView(QTextEdit):
    MODE_LABELS = {
        MODE_ORDER: "In Order", MODE_RANDOM: "Random",
        MODE_WRONG: "Most Wrong",
    }
...
class FlashcardApp(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.btn_inverse.setFixedHeight(36)
