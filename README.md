...
Place any images (`.jpg`, `.jpeg`, `.png`, `.avif`, `.bmp`, `.tiff`) in the `images/` folder named `00` through `99`, then run:

```
python convert_images.py
```

This converts everything to `.webp` in-place and reports which of the 100 cards are missing images.
...
| 85  | foil   | 86  | fudge | 87  | fake   | 88  | fufu   | 89  | fob   |
